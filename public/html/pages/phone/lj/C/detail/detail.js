...
app.config(['$stateProvider', '$locationProvider', function ($stateProvider, $locationProvider) {
    ...
    // 设定路由
    $stateProvider
        .state('ljCDetail', { //app首页
            url: "/phs/lj/C/:phoneId",
            templateUrl: function ($stateParams) {
                return 'pages/phone/lj/C/detail/detail.html';
            },
            controller: "ljCDetailController",
            onExit: function () {
                $("#container").removeClass("overlay-open");
                $("#overlay-hook").html("");
            }
        });
}]).controller('ljCDetailController', ['$scope', '$rootScope', '$location', '$stateParams', '$http', 'Phone', '$cookieStore', '$timeout', function ($scope, $rootScope, $location, $stateParams, $http, Phone, $cookieStore, $timeout) {
